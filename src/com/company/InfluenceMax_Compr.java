...
//        System.out.println("Initializing index I...");
    ...
    void get_sketch() {
        ...
        System.gc();
        get_seeds(iSketch, iNode, node_infl, k, accumulated_sketches, sketch_num, sketch_left);
    }
    ...
    void get_seeds(int[] sketches, int[] nodes, int[] node_infl, int k, int accumulated_sketches, int sketch_num, int sketch_left) {
        ...
        get_seeds(sketches, nodes, node_infl, k-1, accumulated_sketches, sketch_num, sketch_left);
    }
...
//{"/Users/akshaykhot/Desktop/Thesis/code/cnr-2000-t", "0.1"};
